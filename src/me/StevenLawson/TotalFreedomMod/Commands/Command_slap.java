...
@CommandParameters(description = "Allows you to slap a bitch to death faster then you can type /poop", usage = "/<command> <playername>")
public class Command_slam extends TFM_Command
{
    ...
    {
        TFM_Util.adminAction(sender.getName(), " - Slapped " + player + " to death.", false);

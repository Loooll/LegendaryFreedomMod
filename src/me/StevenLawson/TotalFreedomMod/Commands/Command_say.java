    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        if (senderIsConsole && TFM_Util.isFromHostConsole(sender.getName()))
        {
            if (message.equalsIgnoreCase("WARNING: Server is restarting, you will be kicked"))
            {
                ...
                {
                    player.kickPlayer("Server is going offline, may never come back though,make your hopes high k.");
                }
        ...
        TFM_Util.bcastMsg(String.format("[Server:%s] %s", sender.getName(), message), ChatColor.GREEN);

...
public enum TFM_PlayerRank
{
    ...
    OWNER("the " + ChatColor.BLUE + "Founder", ChatColor.BLUE + "[Founder]"),
    CONSOLE("The " + ChatColor.DARK_PURPLE + "Console", ChatColor.DARK_PURPLE + "[Console]"),
    EXECUTIVES("The " + ChatColor.RED + "Executive-Admin", ChatColor.DARK_RED + "[Exe-Admin]"),
    SYSADMIN("a " + ChatColor.DARK_RED + "System Admin", ChatColor.DARK_RED + "[Sys-Admin]"),
    COFOUNDER("The " + ChatColor.BLUE + "Co-Owner", ChatColor.BLUE + "[Co-Founder]"),
    ...
    public static TFM_PlayerRank fromSender(CommandSender sender)
    {
        ...
        if (entry != null && entry.isActivated())
        {
            ...
            if (TFM_ConfigEntry.SERVER_LEADDEVS.getList().contains(sender.getName()))
            {
                return LEADDEV;
            }
